              ...
              <table id="zero-config" class="table dt-table-hover" style="width:100%" data-table="myTable">
                  ...
                  @foreach($data as $website)
                      <tr data-id ="{{$website->id}}">
                          ...
                          <td>{{$website->business_count}} Businesses <a class="view-business-btn" data-webid="59" href="user/websites/{{$website->id}}/businesses"><i class="fa fa-eye mr-2"></i>{{ __('View') }}</a></td>
